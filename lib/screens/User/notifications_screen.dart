...
class _NotificationsScreenState extends State<NotificationsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final room = student != null ? student.room : "402";

    final displayNotifications = _notifications.map((n) {
      final desc = (n["description"] as String).replaceAll("Room 402", "Room $room");
      return {...n, "description": desc};
    }).toList();

    // Group notifications by their 'group' field
    final groups = <String, List<Map<String, dynamic>>>{};
    for (var n in displayNotifications) {
